...
public class MinecraftLauncher
{
  ...
  public static void main(String[] args) throws Exception { if ((args.length > 0) && (args[0].contains("debug"))) {
      debugMode = true;
    }
    ...
    if (heapSizeMegs > 511L) {
      ...
      try
      {
        ...
        if (debugMode) {
          ...
          {
            BufferedReader reader = val$reader1;
          ...
          {
            BufferedReader reader = val$reader2;
